...
//#region node_modules/.nitro/vite/services/ssr/assets/pages-Bp7q8_U9.js
...
async function getAnalytics() {
	const response = await fetch(`${API_BASE_URL}/api/metrics/analytics`);
...
function CaseReplayPage() {
	...
	(0, import_react.useEffect)(() => {
		...
		setCaseData(null);
		setAudit(null);
		Promise.all([getRecoveryCases(), getAuditLogs()]).then(([casesData, auditData]) => {
			if (!active) return;
			const found = (casesData.cases || []).find((c) => String(c.payment_id) === String(caseId));
			if (!found) {
				setCaseData(null);
				return;
			}
			setCaseData(found);
			const match = [...auditData?.records || []].reverse().find((r) => String(r.payment_id) === String(caseId));
			setAudit(match || null);
		}).catch((err) => {
	...
	const humanApproval = policy.requires_human_approval || decision === "REVIEW";
	const actionExecuted = action.status === "EXECUTED";
	const actionLines = [];
	if (action.action !== void 0) actionLines.push(`Action: ${action.action}`);
	if (action.policy_decision !== void 0) actionLines.push(`Policy decision: ${action.policy_decision}`);
	if (action.status !== void 0) actionLines.push(`Status: ${action.status}`);
	if (action.simulated !== void 0) actionLines.push(`Simulated: ${action.simulated ? "yes" : "no"}`);
	if (action.message) actionLines.push(`Message: ${action.message}`);
	if (action.retry_after_hours != null) actionLines.push(`Retry after: ${action.retry_after_hours}h`);
	if (action.executed_at) actionLines.push(`Executed at: ${action.executed_at}`);
	const actionDetail = humanApproval ? "Awaiting human approval. No action is executed until an approval decision is recorded." : decision === "BLOCK" ? action.message || "Execution skipped: the policy decision was not APPROVE." : actionLines.length > 0 ? actionLines.join(" - ") : "No action layer result recorded.";
	...
	return /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
		...
		children: [/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
			...
			className: "py-12 text-center text-sm text-muted-foreground",
			children: "Loading recovery case..."
		}) }) : !caseData ? /* @__PURE__ */ (0, import_jsx_runtime.jsx)(Panel, { children: /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
			className: "py-12 text-center text-sm text-muted-foreground",
			children: [
				"No recovery case found for ",
				caseId,
				"."
			]
		}) }) : /* @__PURE__ */ (0, import_jsx_runtime.jsxs)(import_jsx_runtime.Fragment, { children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)(PageHeader, {
			...
			action: /* @__PURE__ */ (0, import_jsx_runtime.jsx)(Badge, {
				status: decision === "APPROVE" ? "Recovered" : decision === "BLOCK" ? "Blocked" : "Pending",
				children: decision || "NO DATA"
			})
		}), /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
			...
			children: [/* @__PURE__ */ (0, import_jsx_runtime.jsxs)(Panel, {
				...
				children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)(SectionTitle, {
					...
					className: "mt-7",
					children: replaySteps.map((s, i) => /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
						className: "grid grid-cols-[32px_minmax(0,1fr)] gap-4",
						children: [/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
							className: "flex flex-col items-center",
							children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", {
								className: `grid size-8 place-items-center rounded-full border ${s.tone === "policy" ? "border-primary/40 bg-primary-soft text-primary" : s.tone === "failure" ? "border-danger/40 bg-danger-soft text-danger" : s.tone === "pending" ? "border-warning/40 bg-warning-soft text-warning" : "border-ai/30 bg-ai-soft text-ai"}`,
								children: s.tone === "failure" ? /* @__PURE__ */ (0, import_jsx_runtime.jsx)(X, { className: "size-3.5" }) : s.tone === "policy" ? /* @__PURE__ */ (0, import_jsx_runtime.jsx)(ShieldCheck, { className: "size-3.5" }) : s.tone === "action" ? /* @__PURE__ */ (0, import_jsx_runtime.jsx)(Zap, { className: "size-3.5" }) : s.tone === "pending" ? /* @__PURE__ */ (0, import_jsx_runtime.jsx)(Clock3, { className: "size-3.5" }) : /* @__PURE__ */ (0, import_jsx_runtime.jsx)(Check, { className: "size-3.5" })
							}), i < replaySteps.length - 1 && /* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", { className: "my-1 min-h-10 w-px flex-1 bg-border" })]
						}), /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
							className: "pb-7",
							children: [/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
				...
				children: [
					/* @__PURE__ */ (0, import_jsx_runtime.jsxs)(Panel, { children: [
						...
						/* @__PURE__ */ (0, import_jsx_runtime.jsx)("p", {
							...
							children: proposal.proposal || proposal.action || "No proposal recorded."
						})
					] }),
					/* @__PURE__ */ (0, import_jsx_runtime.jsxs)(Panel, {
						...
						children: [
							...
							/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("p", {
								className: "mt-2 text-xs leading-5 text-muted-foreground",
								children: [policy.reason || (decision === "APPROVE" ? "Action is within policy." : "Action is outside policy."), humanApproval ? " This case requires a human." : ""]
							})
						]
					}),
					/* @__PURE__ */ (0, import_jsx_runtime.jsxs)(Panel, { children: [
						...
						/* @__PURE__ */ (0, import_jsx_runtime.jsx)("p", {
							className: "mt-3 text-sm font-semibold",
							children: humanApproval ? "Awaiting human approval" : actionExecuted ? "Executed permitted action" : "Execution skipped"
						}),
						/* @__PURE__ */ (0, import_jsx_runtime.jsx)("p", {
							className: "mt-2 text-xs leading-5 text-muted-foreground",
...
function ApprovalsPage() {
	...
	const pending = (pendingCases || []).filter((c) => (c.final_decision === "BLOCK" || c.final_decision === "REVIEW") && !c.human_approval);
	const refreshCases = () => {
		getRecoveryCases().then((data) => setPendingCases(data.cases || [])).catch((error) => console.error("Approvals reload error:", error));
	};
...
function AnalyticsPage() {
	...
	const [error, setError] = (0, import_react.useState)(null);
	(0, import_react.useEffect)(() => {
		getAnalytics().then(setData).catch((e) => {
			setError("Failed to load analytics.");
			console.error("Analytics error:", e);
		}).finally(() => setLoading(false));
	}, []);
	const fmtLakh = (n) => "₹" + (Number(n || 0) / 1e5).toLocaleString("en-IN", {
	...
	const rootCauses = data ? Object.entries(data.diagnosis_counts || {}).map(([key, val], idx) => ({
		name: key.replaceAll("_", " ").toLowerCase().replace(/\b\w/g, (c) => c.toUpperCase()),
		value: Math.round(val / (data.total_records || 1) * 100),
		fill: palette[idx % palette.length]
	})) : [];
	const trend = data?.recovery_trend || [];
	const approvedRate = data ? (data.approved_recoveries / (data.total_records || 1) * 100).toFixed(1) : "0";
	const blockedRate = data ? (data.blocked_recoveries / (data.total_records || 1) * 100).toFixed(1) : "0";
	return /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
		className: "space-y-6",
		children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)(PageHeader, {
			...
			/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
				...
				children: [
					/* @__PURE__ */ (0, import_jsx_runtime.jsx)(Metric, {
						label: "Revenue at risk",
						value: fmtLakh(data.revenue_at_risk),
						change: `${data.total_records} records`
					}),
					/* @__PURE__ */ (0, import_jsx_runtime.jsx)(Metric, {
						label: "Revenue recovered",
						value: fmtLakh(data.expected_recovery),
						change: "expected recovery",
						tone: "success"
					}),
					/* @__PURE__ */ (0, import_jsx_runtime.jsx)(Metric, {
						label: "Recovery rate",
						value: `${data.expected_recovery_rate}%`,
						change: "of revenue at risk"
					}),
					/* @__PURE__ */ (0, import_jsx_runtime.jsx)(Metric, {
						label: "Recovery uplift",
						value: `${approvedRate}%`,
						change: "approved recovery rate"
					})
				]
			}),
			/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
				...
				children: [
					/* @__PURE__ */ (0, import_jsx_runtime.jsxs)(Panel, { children: [
						...
						/* @__PURE__ */ (0, import_jsx_runtime.jsx)("p", {
							...
							children: data.blocked_recoveries
						}),
						/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("p", {
							className: "mt-2 text-xs text-danger",
							children: [blockedRate, "% of records"]
						})
					] }),
					/* @__PURE__ */ (0, import_jsx_runtime.jsxs)(Panel, { children: [
						/* @__PURE__ */ (0, import_jsx_runtime.jsx)("p", {
						...
						/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("p", {
							...
							children: [fmtLakh(data.blocked_at_risk), " exposure avoided"]
						})
					] }),
					/* @__PURE__ */ (0, import_jsx_runtime.jsxs)(Panel, { children: [
						/* @__PURE__ */ (0, import_jsx_runtime.jsx)("p", {
				...
				action: /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
					...
					children: [
						...
						/* @__PURE__ */ (0, import_jsx_runtime.jsxs)(Button, {
							...
							children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)(Check, { className: "size-4" }), status === "saving" ? "Saving…" : "Save changes"]
						})
					]
				})
			}),
