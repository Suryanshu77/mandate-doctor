...
import { BrainCircuit, Check, CheckCircle2, ChevronRight, Clock3, Download, Filter, History, Pause, Play, Search, ShieldCheck, TrendingUp, X, Zap } from "lucide-react";
...
function Badge({ status, children }) {
	...
	return /* @__PURE__ */ jsxs("span", {
		...
		children: [/* @__PURE__ */ jsx("span", { className: "size-1.5 rounded-full bg-current" }), children ?? status]
	});
}
...
function Metric({ label, value, change, tone = "default" }) {
	return /* @__PURE__ */ jsxs(Panel, {
		...
		children: [
			/* @__PURE__ */ jsx("div", { className: "absolute inset-x-0 top-0 h-px bg-gradient-to-r from-transparent via-primary/50 to-transparent opacity-0 transition-opacity group-hover:opacity-100" }),
			/* @__PURE__ */ jsx("p", {
...
//#endregion
//#region src/components/pages.tsx
var tipStyle = {
...
function Principle() {
	return /* @__PURE__ */ jsxs("div", {
		...
		children: [/* @__PURE__ */ jsx(BrainCircuit, { className: "size-4 shrink-0 text-ai" }), /* @__PURE__ */ jsxs("p", {
...
function CasesTable({ rows = cases }) {
	return /* @__PURE__ */ jsx("div", {
		...
		children: /* @__PURE__ */ jsxs("table", {
			...
			children: [/* @__PURE__ */ jsx("thead", { children: /* @__PURE__ */ jsxs("tr", {
			...
			}) }), /* @__PURE__ */ jsx("tbody", { children: rows.map((c) => /* @__PURE__ */ jsxs("tr", {
				...
				children: [
					...
					/* @__PURE__ */ jsx("td", {
						className: "py-4",
						children: /* @__PURE__ */ jsx(Badge, { status: c.status })
					}),
					/* @__PURE__ */ jsx("td", {
						className: "py-4",
		...
		children: [
			/* @__PURE__ */ jsx(PageHeader, {
				...
				action: /* @__PURE__ */ jsxs(Button, {
					variant: "secondary",
					children: [/* @__PURE__ */ jsx(Download, { className: "size-4" }), "Export report"]
				})
			}),
			/* @__PURE__ */ jsxs("section", {
				className: "relative overflow-hidden rounded-xl border border-border bg-card px-6 py-8 sm:px-8",
				children: [
					/* @__PURE__ */ jsx("div", { className: "grid-noise absolute inset-0 opacity-60" }),
					/* @__PURE__ */ jsx("div", { className: "absolute -right-24 -top-32 size-80 rounded-full bg-primary/10 blur-3xl" }),
					/* @__PURE__ */ jsxs("div", {
						className: "relative grid gap-8 lg:grid-cols-[1.2fr_1fr] lg:items-end",
						children: [/* @__PURE__ */ jsxs("div", { children: [
							/* @__PURE__ */ jsxs("div", {
								className: "flex items-center gap-2",
								children: [/* @__PURE__ */ jsx("span", { className: "size-2 animate-pulse rounded-full bg-danger" }), /* @__PURE__ */ jsx("span", {
			...
			/* @__PURE__ */ jsxs("div", {
				...
				children: [/* @__PURE__ */ jsxs(Panel, { children: [
					...
					/* @__PURE__ */ jsx("div", {
						...
						children: funnel.map((item, i) => /* @__PURE__ */ jsxs("div", {
							...
							children: [/* @__PURE__ */ jsxs("span", {
								...
								children: [/* @__PURE__ */ jsx("div", { className: "absolute inset-y-0 left-0 w-full bg-gradient-to-r from-primary/20 to-ai/10" }), /* @__PURE__ */ jsxs("div", {
						...
						children: /* @__PURE__ */ jsx(ResponsiveContainer, {
							...
							children: /* @__PURE__ */ jsxs(AreaChart, {
								...
								children: [
									...
									/* @__PURE__ */ jsx(Tooltip, { contentStyle: tipStyle }),
									/* @__PURE__ */ jsx(Area, {
										type: "monotone",
										dataKey: "doctor",
										stroke: "var(--primary)",
					...
					/* @__PURE__ */ jsxs("div", {
						...
						children: [/* @__PURE__ */ jsxs("span", {
							className: "flex items-center gap-2",
							children: [/* @__PURE__ */ jsx("i", { className: "size-2 rounded-full bg-primary" }), "Mandate Doctor"]
						}), /* @__PURE__ */ jsxs("span", {
							className: "flex items-center gap-2",
							children: [/* @__PURE__ */ jsx("i", { className: "size-2 rounded-full bg-muted-foreground" }), "Naive retry"]
						})]
					})
				] })]
			}),
			...
			}), /* @__PURE__ */ jsx(CasesTable, { rows: recentCases })] })
		]
	});
}
	...
	return /* @__PURE__ */ jsxs("div", {
		...
		children: [
			/* @__PURE__ */ jsx(PageHeader, {
				...
				action: /* @__PURE__ */ jsxs(Button, { children: [/* @__PURE__ */ jsx(Zap, { className: "size-4" }), "Run recovery batch"] })
			}),
			/* @__PURE__ */ jsx(Principle, {}),
			/* @__PURE__ */ jsxs(Panel, { children: [/* @__PURE__ */ jsxs("div", {
				...
				children: [/* @__PURE__ */ jsxs("label", {
					...
					variant: "secondary",
					children: [/* @__PURE__ */ jsx(Filter, { className: "size-4" }), "Filters"]
				})]
			}), loading ? /* @__PURE__ */ jsx("div", {
				className: "py-12 text-center text-sm text-muted-foreground",
				children: "Loading recovery cases..."
			}) : /* @__PURE__ */ jsx(CasesTable, { rows })] })
		]
	});
}
var steps = [
	...
	return /* @__PURE__ */ jsxs("div", {
		...
		children: [
			...
			/* @__PURE__ */ jsx(PageHeader, {
				...
				action: /* @__PURE__ */ jsx(Badge, { status: "Pending" })
			}),
			/* @__PURE__ */ jsxs("div", {
				...
				children: [/* @__PURE__ */ jsxs(Panel, {
					...
					children: [/* @__PURE__ */ jsx(SectionTitle, {
						...
						action: /* @__PURE__ */ jsxs(Button, {
							variant: "secondary",
							children: [/* @__PURE__ */ jsx(Play, { className: "size-4" }), "Replay"]
						})
					}), /* @__PURE__ */ jsx("div", {
						className: "mt-7",
						children: steps.map((s, i) => /* @__PURE__ */ jsxs("div", {
							...
							children: [/* @__PURE__ */ jsxs("div", {
								...
								children: [/* @__PURE__ */ jsx("div", {
									...
									children: s[3] === "failure" ? /* @__PURE__ */ jsx(X, { className: "size-3.5" }) : s[3] === "policy" ? /* @__PURE__ */ jsx(ShieldCheck, { className: "size-3.5" }) : s[3] === "action" ? /* @__PURE__ */ jsx(Zap, { className: "size-3.5" }) : s[3] === "pending" ? /* @__PURE__ */ jsx(Clock3, { className: "size-3.5" }) : /* @__PURE__ */ jsx(Check, { className: "size-3.5" })
								}), i < steps.length - 1 && /* @__PURE__ */ jsx("div", { className: "my-1 min-h-10 w-px flex-1 bg-border" })]
							}), /* @__PURE__ */ jsxs("div", {
								className: "pb-7",
								children: [/* @__PURE__ */ jsxs("div", {
					...
					children: [
						...
						/* @__PURE__ */ jsxs(Panel, { children: [
							...
							/* @__PURE__ */ jsx("div", {
								...
								children: /* @__PURE__ */ jsx("div", { className: "h-full w-[86%] rounded-full bg-success" })
							})
						] })
					]
				})]
...
function ApprovalsPage() {
	...
	return /* @__PURE__ */ jsxs("div", {
		...
		children: [
			...
			/* @__PURE__ */ jsx("div", {
				className: "space-y-4",
				children: loading ? /* @__PURE__ */ jsx(Panel, { children: /* @__PURE__ */ jsx("div", {
					className: "py-12 text-center text-sm text-muted-foreground",
					children: "Loading approval queue..."
				}) }) : pending.length === 0 ? /* @__PURE__ */ jsx(Panel, { children: /* @__PURE__ */ jsx("div", {
					className: "py-12 text-center text-sm text-muted-foreground",
					children: "No approval decisions currently required."
				}) }) : pending.map((c) => /* @__PURE__ */ jsx(Panel, {
					...
					children: /* @__PURE__ */ jsxs("div", {
						...
						children: [
							...
							/* @__PURE__ */ jsxs("div", {
								...
								children: [completed.includes(c.payment_id) ? /* @__PURE__ */ jsxs("div", {
									className: "flex items-center gap-2 text-sm font-medium text-success",
									children: [/* @__PURE__ */ jsx(CheckCircle2, { className: "size-5" }), "Decision recorded"]
									...
									children: [/* @__PURE__ */ jsx(Check, { className: "size-4" }), busyId === c.payment_id ? "Submitting..." : "Approve"]
								}), /* @__PURE__ */ jsxs(Button, {
									variant: "danger",
									className: "flex-1 lg:w-full",
									disabled: busyId === c.payment_id,
									onClick: () => handleDecision(c.payment_id, "REJECT"),
									children: [/* @__PURE__ */ jsx(X, { className: "size-4" }), "Reject"]
								})] }), errors[c.payment_id] && /* @__PURE__ */ jsx("p", {
					...
					/* @__PURE__ */ jsx("div", {
						...
						children: /* @__PURE__ */ jsx(ResponsiveContainer, {
							...
							children: /* @__PURE__ */ jsxs(PieChart, { children: [/* @__PURE__ */ jsx(Pie, {
								...
								paddingAngle: 3,
								dataKey: "value",
								children: rootCauses.map((r) => /* @__PURE__ */ jsx(Cell, { fill: r.fill }, r.name))
							}), /* @__PURE__ */ jsx(Tooltip, { contentStyle: tipStyle })] })
						})
					}),
					/* @__PURE__ */ jsx("div", {
						className: "space-y-2",
						children: rootCauses.map((r) => /* @__PURE__ */ jsxs("div", {
		...
		children: [
			...
			/* @__PURE__ */ jsx(Panel, { children: /* @__PURE__ */ jsxs("div", {
				...
				children: [/* @__PURE__ */ jsxs("select", {
					...
					}), logs.map((log, index) => /* @__PURE__ */ jsx("option", {
						value: String(index),
					...
					disabled: !selected,
					children: [playing ? /* @__PURE__ */ jsx(Pause, { className: "size-4" }) : /* @__PURE__ */ jsx(Play, { className: "size-4" }), playing ? "Pause replay" : "Replay decision"]
				})]
			}) }),
			error ? /* @__PURE__ */ jsx(Panel, { children: /* @__PURE__ */ jsx("p", {
				className: "py-12 text-center text-sm text-danger",
				children: error
			}) }) : loading ? /* @__PURE__ */ jsx(Panel, { children: /* @__PURE__ */ jsx("div", {
				className: "py-12 text-center text-sm text-muted-foreground",
				children: "Loading audit records..."
			}) }) : !selected ? /* @__PURE__ */ jsx(Panel, { children: /* @__PURE__ */ jsx("div", {
				className: "py-12 text-center text-sm text-muted-foreground",
				...
				children: [/* @__PURE__ */ jsxs(Panel, { children: [/* @__PURE__ */ jsx(SectionTitle, {
					...
					children: replaySteps.map((step, index) => /* @__PURE__ */ jsxs("div", {
						className: `grid grid-cols-[20px_minmax(0,1fr)] gap-3 rounded-lg p-3 transition-all ${playing ? "bg-accent" : ""}`,
						children: [/* @__PURE__ */ jsxs("div", {
							className: "relative flex justify-center",
							children: [/* @__PURE__ */ jsx("span", { className: `mt-1.5 size-2 rounded-full ${step.tone === "failure" ? "bg-danger" : step.tone === "policy" ? "bg-primary" : step.tone === "ai" ? "bg-ai" : step.tone === "result" ? "bg-success" : "bg-warning"}` }), index < replaySteps.length - 1 && /* @__PURE__ */ jsx("span", { className: "absolute top-4 h-12 w-px bg-border" })]
						}), /* @__PURE__ */ jsxs("div", { children: [/* @__PURE__ */ jsx("p", {
							className: "text-sm font-semibold",
							children: step.title
						}), step.lines ? step.lines.map((line, i) => /* @__PURE__ */ jsx("p", {
					...
					children: [
						...
						/* @__PURE__ */ jsxs(Panel, { children: [/* @__PURE__ */ jsx("p", {
							...
							children: [/* @__PURE__ */ jsx(CheckCircle2, { className: "size-4" }), "Trace verified"]
						})] })
					]
				})]
			})
	...
	return /* @__PURE__ */ jsxs("div", {
		...
		children: [
			/* @__PURE__ */ jsx(PageHeader, {
				...
				action: /* @__PURE__ */ jsxs(Button, { children: [/* @__PURE__ */ jsx(Check, { className: "size-4" }), "Save changes"] })
			}),
			/* @__PURE__ */ jsx(Principle, {}),
			/* @__PURE__ */ jsxs("div", {
						...
						/* @__PURE__ */ jsxs(Panel, {
							...
							children: [/* @__PURE__ */ jsxs("div", {
								...
								children: [/* @__PURE__ */ jsxs("div", { children: [/* @__PURE__ */ jsx("p", {
									...
									children: /* @__PURE__ */ jsx("span", { className: `absolute top-1 size-4 rounded-full bg-foreground transition-transform ${kill ? "translate-x-6" : "translate-x-1"}` })
								})]
							}), kill && /* @__PURE__ */ jsx("div", {
